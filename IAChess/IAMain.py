...
from IAChess import IAEngine, IntArt
        ...
        for e in pygame.event.get():
            if e.type == pygame.QUIT:
                ...
                if e.key == pygame.K_e:
                    ...
                    pygame.display.quit()
                    pygame.quit()
                    from util.ChessToMenu import ChessToMenu
                    ChessToMenu()
...
def drawText(screen, text):
    ...
    textLocation = pygame.Rect(0, 0, Board_width, Board_height).move(Board_width/2 - textObj.get_width()/2, Board_height/2 - textObj.get_height()/2)
