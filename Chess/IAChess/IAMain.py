...
def loadImage ():
    ...
    for piece in pieces:
        images[piece] = p.transform.scale(p.image.load("C:/proyectoChess/Chess/images/" + piece + ".png"), (sq_Size, sq_Size))
...
def main():
    ...
    gameOver = False
    playerOne = False #Si el jugador juega blancas, será True, si no, no.
...
def drawText(screen, text):
    ...
    textLocation = p.Rect(0, 0, Board_width, Board_height).move(Board_width/2 - textObj.get_width()/2, Board_height/2 - textObj.get_height()/2)
